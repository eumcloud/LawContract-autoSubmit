...
<body>
		...
		<table width="350px">
			...
			<tr bgcolor="#FAF8F6">
				<th colspan="2"><button onclick="openPopCloss('<%=request.getContextPath()%>/fee/paymentPwProc.jsp');">취소</button><button onclick="openPopCloss('<%=request.getContextPath()%>/fee/paymentPwProc.jsp');">다음</button></th>
			</tr>
		</table>
		</form>
		<br/>
