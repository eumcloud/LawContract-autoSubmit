...
<table class='paper' ><tr><td colspan="2">  
...
<div align=center>계약일 <%=session.getAttribute("date") %></div><br/><br/><br/><br/>
...
<tr><td >
      ...
      <div><td>「을」  성 명 :<%=session.getAttribute("deptor") %> (인)
